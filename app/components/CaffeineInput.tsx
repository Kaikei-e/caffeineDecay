    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center p-5 bg-gray-100 rounded-lg">
            <div className="flex flex-col mb-5">
                <label htmlFor="caffeineTime" className="text-lg font-bold mb-2">Time Consumed:</label>
                <input
                    type="datetime-local"
                    id="caffeineTime"
                    ...
                    className={`p-2 rounded border ${errors.caffeineTime ? 'border-red-500' : 'border-gray-300'}`}
                />
                {errors.caffeineTime && <span className="text-red-500 text-xs">{errors.caffeineTime.message as string}</span>}
            </div>
            <div className="flex flex-col mb-5">
